...
router.post("/addToArticles", pagesController.addToArticles);

router.post("/updatePin", pagesController.updatePin);

router.post("/updateTitle", pagesController.updateTitle);
